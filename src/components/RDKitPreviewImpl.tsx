  ...
  useEffect(() => {
    ...
    async function loadRDKit() {
      ...
      try {
        ...
        // Your install exposes RDKit via the default export.
        // In some builds, default.initRDKitModule exists; in others, default IS the initializer.
        const init = (mod as any).default?.initRDKitModule ?? (mod as any).default;
